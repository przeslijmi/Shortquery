...
/**
 * ShortQuery creator for Core\{instance}Core Model PHP File.
 */
class InstanceCore extends PhpFile
{
    ...
    public function prepare() : self
    {
        ...
        // Call to create.
        ob_start();
        $success        = include $this->getTplUri(PhpFile::TPL_INSTANCE_CORE);
    ...
    public function getUri() : string
    {
        ...
        $result .= '/Core/';
        $result .= $this->model->getClass('instanceCoreClassName');
        $result .= '.php';
