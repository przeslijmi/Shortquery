...
/**
 * FieldFrom in Relation is corrupted - can not be created (instantiated).
 */
class RelationFieldFromIsCorrupted extends ClassFopException
{
    ...
    public function __construct(Relation $relation, ?Throwable $cause = null)
    {
        ...
        $this->addInfo('hint', 'Relation has FieldFrom defined but when tries to instantiate it ... fails. See causes.');
